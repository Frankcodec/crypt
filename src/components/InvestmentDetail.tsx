...
const InvestmentDetail: React.FC = () => {
  ...
  const fetchInvestment = async () => {
    try {
      const res = await fetch(`http://localhost/crypto-backend/get_investment_by_id.php?id=${id}`);
  ...
  const handleClaim = async () => {
    ...
    try {
      const res = await fetch('http://localhost/crypto-backend/claim_payout.php', {
        method: 'POST',
