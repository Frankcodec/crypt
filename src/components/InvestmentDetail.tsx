...
const InvestmentDetail: React.FC = () => {
  ...
  const fetchInvestment = async () => {
    try {
      const res = await fetch(`https://mondayonsol.fun/crypto-backend/crypto-backend/get_investment_by_id.php?id=${id}`);
  ...
  const handleClaim = async () => {
    ...
    try {
      const res = await fetch('https://mondayonsol.fun/crypto-backend/crypto-backend/claim_payout.php', {
        method: 'POST',
