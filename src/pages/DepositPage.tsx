...
const DepositModal = ({ show, onClose, amount, refreshData }: any) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const res = await fetch('https://mondayonsol.fun/crypto-backend/log_deposit.php', {
        method: 'POST',
...
const DepositPage: React.FC = () => {
  ...
  const fetchHistory = async () => {
    const res = await fetch(`https://mondayonsol.fun/crypto-backend/get_transactions.php?user_id=${user.id}&type=deposit`);
