...
const PlatformSettings: React.FC = () => {
  ...
  try {
    const res = await fetch('https://api.nutcoinonsol.com/crypto-backend/admin/manage_settings.php');
  ...
  const handleSave = async () => {
    try {
      const res = await fetch(
        "https://api.nutcoinonsol.com/crypto-backend/admin/manage_settings.php",
        {
          method: "POST",
