...
const AdminApprovePlan: React.FC = () => {
  ...
  const fetchInvestments = async () => {
    try {
      const res = await fetch('https://api.nutcoinonsol.com/crypto-backend/admin/get_all_investments.php');
  ...
  const handleAction = async (id: number, action: 'approve' | 'reject') => {
    ...
    if (confirm.isConfirmed) {
      try {
        const res = await fetch(`https://api.nutcoinonsol.com/crypto-backend/admin/${action}_investment.php`, {
          method: 'POST',
