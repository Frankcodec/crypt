...
const AdminPlans: React.FC = () => {
  ...
  const fetchPlans = async () => {
    setLoading(true);
    try {
      const res = await fetch('https://api.nutcoinonsol.com/crypto-backend/admin/get_plans.php');
  ...
  const handleAddPlan = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('https://api.nutcoinonsol.com/crypto-backend/admin/add_plan.php', {
        method: 'POST',
  ...
  const handleHidePlan = async (id: number) => {
    ...
    if (confirm.isConfirmed) {
      try {
        const res = await fetch('https://api.nutcoinonsol.com/crypto-backend/admin/delete_plan.php', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
