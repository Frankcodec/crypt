...
const AdminWallets: React.FC = () => {
  ...
  const fetchWallets = async () => {
    setLoading(true);
    try {
      const res = await fetch('http://localhost/crypto-backend/admin/get_wallets.php');
  ...
  const handleAddWallet = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('http://localhost/crypto-backend/admin/add_wallet.php', {
        method: 'POST',
  ...
  const handleDelete = async (id: number) => {
    ...
    if (result.isConfirmed) {
      try {
        const res = await fetch('http://localhost/crypto-backend/admin/delete_wallet.php', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
